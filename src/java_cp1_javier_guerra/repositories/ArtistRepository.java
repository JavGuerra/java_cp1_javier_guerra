...
public final class ArtistRepository {
    ...
    private Artist exampleArtist() {
        ...
        Media analog1 = new AnalogMedia(1L, 1L, "Analógico1", MediaFormat.LP, "33 1/3");
        analog1.addNewSongs(Set.of(song1, song2, song3, song4));

        Media analog2 = new AnalogMedia(2L, 1L, "Analógico2", MediaFormat.CASSETTE, "Normal");
        analog2.addNewSongs(Set.of(song5, song6, song7));

        Media digital1 = new DigitalMedia(3L, 1L, "Digital1", MediaFormat.CD, "CDA");
